...
@DatasetReader.register("math23k_transformer")
class Math23kTransformerReader(DatasetReader):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._tokenizer = PretrainedTransformerTokenizer(
            transformer_model_name, add_special_tokens=True, tokenizer_kwargs={
                "additional_special_tokens": ["<NUM>"]})
        self._source_token_indexers = {
            "tokens": PretrainedTransformerIndexer(model_name=transformer_model_name)}
    ...
    def text_to_instance(
        ...
        tokens = self._tokenizer.tokenize(" ".join(problem_tokens))
