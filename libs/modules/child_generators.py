...
class ChildGenerator(torch.nn.Module, Registrable):
...
@ChildGenerator.register("binary")
class BinaryGenerator(ChildGenerator):
    """
...
@ChildGenerator.register("gru")
class GRUGenerator(ChildGenerator):
    """
